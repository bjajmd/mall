                ...
                <div class="layui-tab-content">
                    ...
                    <div class="aboutinfo">
                        ...
                        <div class="aboutinfo-contact">
                            ...
                            <a target="_blank" title="给我写信" href="mailto:110@qq.com"><i class="fa fa-envelope fa-2x"></i></a>
                            <a target="_blank" title="新浪微博" href="https://weibo.com"><i class="fa fa-weibo fa-2x"></i></a>
                            <a target="_blank" title="码云" href="https://gitee.com"><i class="fa fa-git fa-2x"></i></a>
                        </div>
                    </div>
