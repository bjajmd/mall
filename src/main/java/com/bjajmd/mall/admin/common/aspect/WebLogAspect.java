package com.bjajmd.mall.admin.common.aspect;

import com.alibaba.fastjson.JSONObject;
import com.bjajmd.mall.admin.common.MySysUser;
import com.bjajmd.mall.admin.common.exception.GlobalExceptionHandler;
import com.bjajmd.mall.admin.common.util.ToolUtil;
import com.bjajmd.mall.admin.entity.Log;
...
public class WebLogAspect {
    ...
    @Pointcut("@annotation(com.bjajmd.mall.admin.common.annotation.SysLog)")
    public void webLog(){}
    ...
    public void doBefore(JoinPoint joinPoint) {
        ...
        com.bjajmd.mall.admin.common.annotation.SysLog mylog = method.getAnnotation(com.bjajmd.mall.admin.common.annotation.SysLog.class);
        if(mylog != null){
            //注解上的描述
